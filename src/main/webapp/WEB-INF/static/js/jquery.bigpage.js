...
(function($) {
	...
	$.bigPage.addCssWidget({
		...
		format :function($table){
			...
			var footPageHtml = '<div ajaxpage="foot" class="bigpage"><a class="' + prevClass +'" href="javascript:void(0)" ajaxpage="prev" >上一页</a><span class="dqPages">'+dAS +'/'+ endOption+ '</span>' + '<a class="' + nextClass + '" href="javascript:void(0)" ajaxpage="next">下一页</a><input type="text" size="5" maxlength="5" ajaxpage="text" class="inputPage"><a href="javascript:void(0)" ajaxpage="skipA" class="aSkip" >跳转</a></div>';
